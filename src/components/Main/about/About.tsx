    ...
    <>
      <Box>
        ...
        <Typography variant="body1" color="secondary" component="p">
          ...
          pretavil to do vášne, ktorú mám k technológiám. Dnes som s
          programovaním vo fáze, kde už viem zápasiť aj so zložitejšími
          procesmi.
        </Typography>
        <Typography variant="body2" color="primary" component="p">
          ...
          rozvíjať ďalej za pomoci týchto dvoch silných nástrojov. Každým dňom
          sa dostávam ďalej a som vďačný za každého, kto mi s tým pomohol, či už

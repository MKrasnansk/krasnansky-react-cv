...
import "../../../assets/styles/stylesCv.scss";
import { DownloadFiles } from "./DownloadFIles";
export const Curiculum: React.FC = () => {
	const desktop = useMediaQuery("(min-width:600px)");
	return (
		<>
			{!desktop && <DownloadFiles />}
			{desktop && (
				<div>
						...
						<div className="container">
							<aside className="aside">
								<div>
									...
									<small>Web developer - junior</small>
								</div>
								<h3 className="dark">Kontaktné údaje</h3>
								...
								<div className="skills">
									...
									<div className="basic"></div>
									<p>
										<strong>Pug/Handlebars/Ejs</strong>
									</p>
									<div className="full"></div>
									<p>
									...
									<div className="basic"></div>
									<p>
										<strong> Illustrator, Photoshop, XD</strong>
									</p>
									<div className="full"></div>
									<p>
							...
							<article className="article">
								<p>
									Zaujímam sa o programovanie, predovšetkým <span>front-end</span> s presahom do back-end, veľmi ma baví práca s <span>CSS</span> a<span>JavaScript</span>-om. Intenzívne sa učím viac ako rok, rád získavam informácie
									a neustále rozvíjam svoje zručnosti. S programovaním sa stretávam na dennej báze. Viem ako funguje Scrum. Bol som aj členom v developerskom teame. Za každý prejavený záujem o moje skúsenosti, budem veľmi vďačný.
									Svoj záujem smerujem predovšetkým na technológie (<span>React.js, TypeScript, Material-UI, Css/Sass, Nest.js(Node.js) + NoSql</span>
								...
								<hr />
								<p>Anglický jazyk: pokročilý - denné štúdium</p>
								<p>Vodičský preukaz typu: A, B, D, T</p>
							</article>
						</div>
					</div>
					<DownloadFiles />

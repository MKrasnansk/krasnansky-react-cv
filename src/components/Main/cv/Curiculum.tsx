				...
				<div className="curiculum">
					<div className="container">
						...
						<article className="article">
							<p>
								Zaujímam sa o programovanie, predovšetkým <span>front-end</span> s presahom do back-end, veľmi ma baví práca s <span>CSS</span> a<span>JavaScript</span>-om. Intenzívne sa učím viac ako rok, rád získavam informácie a
								neustále rozvíjam svoje zručnosti. S programovaním sa stretávam na dennej báze. Viem ako funguje Scrum. Bol som aj členom v developerskom teame. Za každý prejavený záujem o moje skúsenosti, budem veľmi vďačný. Svoj
								záujem smerujem predovšetkým na technológie (<span>React.js, TypeScript, Material-UI, Css/Sass, Nest.js(Node.js) + NoSql</span>
